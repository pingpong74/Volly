...
void Volly::Instance::InstanceImpl::setupDebugMessenger() {
...
VKAPI_ATTR VkBool32 VKAPI_CALL Volly::Instance::InstanceImpl::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
...
Volly::PhysicalDevice Volly::Instance::InstanceImpl::selectPhysicalDevice() {
...
Volly::Device Volly::Instance::InstanceImpl::createDevice(const DeviceCreateInfo& deviceCreateInfo) {
